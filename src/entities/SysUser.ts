...
// Created:     2025-07-27T06:00:00+05:30
// Updated:     2025-07-27T06:00:00+05:30
...
export class SysUser extends Packaged(BaseEntity as any) {
  ...
  @Property()
  password_needs_reset: boolean = false;
  ...
  @Property()
  web_service_access_only: boolean = false;

  // — foreign keys —

  @ManyToOne(() => CmnBuilding, { nullable: true })
  building?: CmnBuilding;
  ...
  @ManyToOne(() => CmnSchedule, { nullable: true })
  schedule?: CmnSchedule;
  ...
  @Property({ length: 151, nullable: true })
